...
class IndustrySector: EmissionSectorStrategy {
    ...
    EmissionSectors(name: "Industry", iconName: "industry", colorName: "", percentageEmission: 0.25, description: "", sustainableActionFunction: [
...
class EnergySector: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Energy", iconName: "energy", colorName: "", percentageEmission: 0.35, description: "", sustainableActionFunction: [
...
class TransportSector: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Transport", iconName: "transport", colorName: "", percentageEmission: 0.20, description: "", sustainableActionFunction: [
...
class DeforestationSector: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Deforestation", iconName: "deforestation", colorName: "", percentageEmission: 0.10, description: "", sustainableActionFunction: [
...
class AgricultureSector: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Agriculture", iconName: "agriculture", colorName: "", percentageEmission: 0.10, description: "", sustainableActionFunction: [
