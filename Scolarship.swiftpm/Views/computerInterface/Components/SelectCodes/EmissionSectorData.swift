...
class IndustrySector: EmissionSectorStrategy {
    ...
    EmissionSectors(name: "Industry", iconName: "industry", colorName: "", percentageEmission: 0.25, description: "", initialCO2Nodes: 10, currentCO2Nodes: 10, sustainableActionFunction: [
...
class EnergySector: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Energy", iconName: "energy", colorName: "", percentageEmission: 0.35, description: "", initialCO2Nodes: 15, currentCO2Nodes: 15, sustainableActionFunction: [
...
class TransportSector: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Transport", iconName: "transport", colorName: "", percentageEmission: 0.20, description: "", initialCO2Nodes: 8, currentCO2Nodes: 8, sustainableActionFunction: [
...
class DeforestationSector: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Deforestation", iconName: "deforestation", colorName: "", percentageEmission: 0.10, description: "", initialCO2Nodes: 4, currentCO2Nodes: 4, sustainableActionFunction: [
...
class AgricultureSector: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Agriculture", iconName: "agriculture", colorName: "", percentageEmission: 0.10, description: "", initialCO2Nodes: 4, currentCO2Nodes: 4, sustainableActionFunction: [
...
class OceanAbsorb: EmissionSectorStrategy {
    ...
    var configuration: EmissionSectors =
    EmissionSectors(name: "Ocean", iconName: "", colorName: "", percentageEmission: 0, description: "", initialCO2Nodes: 0, currentCO2Nodes: 0, sustainableActionFunction: [])
}

class ForestsAbsorb: EmissionSectorStrategy {
    
    var configuration: EmissionSectors =
    EmissionSectors(name: "Forest", iconName: "", colorName: "", percentageEmission: 0, description: "", initialCO2Nodes: 0, currentCO2Nodes: 0, sustainableActionFunction: [])
}
