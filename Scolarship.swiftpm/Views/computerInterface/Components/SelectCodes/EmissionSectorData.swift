...
struct IndustrySector: EmissionSectorStrategy {
    func configure() -> EmissionSectors {
        EmissionSectors(name: "Industry", iconName: "industry", colorName: "", emissions: 1.0, absorption: 0, sustainableActionFunction: [
            ...
            SustainableActionFunction(code: "establishEnvironmentalGoals()", description: "Set goals aligned with your sustainability objectives, enabling an approach tailored to your specific circumstances.", co2ReductionValue: 10, costEcoPoints: 10),
